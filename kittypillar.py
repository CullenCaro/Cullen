...
#Create text to show at begginning
game_started = False
...
#Function to check if caterpillar has left the play area
...
#Fucntion to place a leaf randomly on the screen
def place_leaf():
    leaf.ht()
...
#Init the mainloop and assign actions to keys
